...
namespace Illuminate\Support\Facades {
    ...
    class DB
    {
         ...
         * @static
         */
        public static function registerDoctrineType($class, $name, $type): void
        {
            /** @var \Illuminate\Database\DatabaseManager $instance */
    ...
    class File
    {
         ...
         * @static
         */
        public static function replace($path, $content): void
        {
            /** @var \Illuminate\Filesystem\Filesystem $instance */
    ...
    class Notification
    {
         ...
         * @static
         */
        public static function assertTimesSent($expectedCount, $notification): void
        {
            /** @var \Illuminate\Support\Testing\Fakes\NotificationFake $instance */
    ...
    class Request
    {
         ...
         * @static
         */
        public static function dd(...$keys): void
        {
            /** @var \Illuminate\Http\Request $instance */
            $instance->dd(...$keys);
        }
        ...
        /**
         * @see \App\Providers\AppServiceProvider::requestMacro()
         * @param mixed $key
         * @static
         */
        public static function toCollection($key = null)
        {
            return \Illuminate\Http\Request::toCollection($key);
        }
    }
    /**
...
namespace Illuminate\Support {
    ...
    class Collection
    {
        ...
        {
            return self::downloadExcel($fileName, $writerType, $withHeadings, $responseHeaders);
        }
        ...
        {
            return self::storeExcel($filePath, $disk, $writerType, $withHeadings);
        }

        /**
         * @see \App\Providers\AppServiceProvider::collectionMacro()
         * @param mixed $key
         * @param mixed $default
         * @static
         */
...
namespace Eloverde\Landlord\Facades {
    ...
    class Landlord
    {
        ...
        {
            /** @var \Eloverde\Landlord\TenantManager $instance */
            $instance->enable();
        }
         ...
         *
         * @param $tenantKey
         * @param string|\Illuminate\Database\Eloquent\Model $tenant
         * @throws TenantColumnUnknownException
         * @throws TenantNullIdException
         * @static
         */
        public static function addTenant($tenant, $tenantValue = null)
        {
            /** @var \Eloverde\Landlord\TenantManager $instance */
            return $instance->addTenant($tenant, $tenantValue);
        }
         ...
         *
         * @param \Illuminate\Database\Eloquent\Model|\Eloverde\Landlord\BelongsToTenants $model
         * @static
         */
        ...
        public static function macro($name, $macro): void
        {
            \Eloverde\Landlord\TenantManager::macro($name, $macro);
        }
        ...
        public static function mixin($mixin, $replace = true): void
        {
            \Eloverde\Landlord\TenantManager::mixin($mixin, $replace);
        }
        ...
        public static function hasMacro($name)
        {
            return \Eloverde\Landlord\TenantManager::hasMacro($name);
        }
        ...
        public static function flushMacros(): void
        {
            \Eloverde\Landlord\TenantManager::flushMacros();
        }
    }
...
namespace Maatwebsite\Excel\Facades {
    ...
    class Excel
    {
         ...
         * @static
         */
        public static function matchByRegex(): void
        {
         ...
         * @static
         */
        public static function doNotMatchByRegex(): void
        {
            /** @var \Maatwebsite\Excel\Fakes\ExcelFake $instance */
...
namespace  {
    ...
    class Landlord extends \Eloverde\Landlord\Facades\Landlord
    {
    }
